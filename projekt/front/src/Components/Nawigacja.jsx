...
import logoIcon from "../Images/savings.png"
...
const Nawigacja=() => {
    ...
    <div className="container">
      <div className="content">
        ...
        <img src={logoIcon} alt="Logo" className="logo-image" width="42" height="42"/>
        <span className="logo-text">$KARBONKA</span>
      </div>
        <ul className="nav-ul">
        <li className="main-header-navbar"><NavLink to='/'>STRONA GŁÓWNA</NavLink></li>
          <nav>
            {auth ? <><li><NavLink onClick={logout} to='login'>Wyloguj się</NavLink></li><li><NavLink to='settings'>Ustawienia</NavLink></li>{accountType=='p'? <li><NavLink to='new' >Nowa skarbonka</NavLink></li>: null}</>
            : 
            <>
